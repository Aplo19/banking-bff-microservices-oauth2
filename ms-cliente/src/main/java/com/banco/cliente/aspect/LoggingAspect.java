package com.banco.cliente.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.banco.cliente.controller.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.banco.cliente.controller.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.banco.cliente.*.*.*(..))", throwing = "error")
